document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener('click', function(e) {
    ...
    // Ignore links with only "#" or empty
    if (!href || href === '#') return;
  ...
  // Form validation for contact forms (event delegation)
  document.addEventListener('submit', function(e) {
    ...
    inputs.forEach(function(input) { input.classList.remove('invalid'); });
    ...
    if (nameField && !nameField.value.trim()) {
      showError(nameField, 'الاسم مطلوب');
    }
    ...
    if (emailField) {
      ...
      if (!email) {
        showError(emailField, 'البريد الإلكتروني مطلوب');
    ...
    if (messageField && !messageField.value.trim()) {
      showError(messageField, 'الرسالة مطلوبة');
    }

    if (isValid) {
      // Form is valid - you could submit it programmatically or show success
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'de06885e-1c6b-475b-941e-2f0fdef86098',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'de06885e-1c6b-475b-941e-2f0fdef86098';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'de06885e-1c6b-475b-941e-2f0fdef86098';
